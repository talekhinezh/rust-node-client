...
pub struct LtsFeeFungibleResourceBalanceChange {
    #[serde(rename = "type")]
    pub r#type: crate::models::LtsFeeFungibleResourceBalanceChangeType,
...
impl LtsFeeFungibleResourceBalanceChange {
    pub fn new(r#type: crate::models::LtsFeeFungibleResourceBalanceChangeType, resource_address: String, balance_change: String) -> LtsFeeFungibleResourceBalanceChange {
