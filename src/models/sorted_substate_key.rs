...
pub struct SortedSubstateKey {
    ...
    pub key_type: crate::models::SubstateKeyType,
    /// The hex-encoded bytes of the partially-hashed DB sort key, under the given entity partition
    #[serde(rename = "db_sort_key_hex", deserialize_with = "Option::deserialize")]
    pub db_sort_key_hex: Option<serde_json::Value>,
...
impl SortedSubstateKey {
    pub fn new(key_type: crate::models::SubstateKeyType, db_sort_key_hex: Option<serde_json::Value>, sort_prefix_hex: String, key_hex: String) -> SortedSubstateKey {
        SortedSubstateKey {
            key_type,
            db_sort_key_hex,
            sort_prefix_hex,
