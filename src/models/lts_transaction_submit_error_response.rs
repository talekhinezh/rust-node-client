...
pub struct LtsTransactionSubmitErrorResponse {
    ...
    pub error_type: crate::models::ErrorResponseType,
    ...
    pub details: Option<Box<crate::models::LtsTransactionSubmitErrorDetails>>,
}

impl LtsTransactionSubmitErrorResponse {
    pub fn new(error_type: crate::models::ErrorResponseType, code: Option<serde_json::Value>, message: Option<serde_json::Value>) -> LtsTransactionSubmitErrorResponse {
