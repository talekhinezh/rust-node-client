...
pub struct BlueprintSchemaFieldPartition {
    ...
    #[serde(rename = "fields")]
    pub fields: Vec<crate::models::FieldSchema>,
}

impl BlueprintSchemaFieldPartition {
    /// The fields partition of the blueprint.
    pub fn new(partition_description: crate::models::PartitionDescription, fields: Vec<crate::models::FieldSchema>) -> BlueprintSchemaFieldPartition {
