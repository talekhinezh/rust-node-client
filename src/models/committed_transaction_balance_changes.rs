...
impl CommittedTransactionBalanceChanges {
    pub fn new(fungible_entity_balance_changes: Vec<models::LtsEntityFungibleBalanceChanges>, non_fungible_entity_balance_changes: Vec<models::LtsEntityNonFungibleBalanceChanges>) -> CommittedTransactionBalanceChanges {
