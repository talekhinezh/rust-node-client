...
pub struct LtsTransactionStatusResponse {
    ...
    pub intent_status: models::LtsTransactionIntentStatus,
    ...
    pub known_payloads: Vec<models::LtsTransactionPayloadDetails>,
}

impl LtsTransactionStatusResponse {
    pub fn new(intent_status: models::LtsTransactionIntentStatus, status_description: String, known_payloads: Vec<models::LtsTransactionPayloadDetails>) -> LtsTransactionStatusResponse {
