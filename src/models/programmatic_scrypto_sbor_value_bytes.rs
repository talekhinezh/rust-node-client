...
impl ProgrammaticScryptoSborValueBytes {
    pub fn new(kind: crate::models::ProgrammaticScryptoSborValueKind, element_kind: crate::models::ProgrammaticScryptoSborValueKind, hex: String) -> ProgrammaticScryptoSborValueBytes {
