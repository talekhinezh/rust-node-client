...
pub struct BinaryPlaintextMessageContent {
    #[serde(rename = "type")]
    pub r#type: crate::models::PlaintextMessageContentType,
...
impl BinaryPlaintextMessageContent {
    pub fn new(r#type: crate::models::PlaintextMessageContentType, value_hex: String) -> BinaryPlaintextMessageContent {
