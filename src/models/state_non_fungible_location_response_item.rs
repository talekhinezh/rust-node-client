...
pub struct StateNonFungibleLocationResponseItem {
    ...
    #[serde(rename = "owning_vault_address", skip_serializing_if = "Option::is_none")]
...
impl StateNonFungibleLocationResponseItem {
    pub fn new(non_fungible_id: String, is_burned: bool, last_updated_at_state_version: i64) -> StateNonFungibleLocationResponseItem {
