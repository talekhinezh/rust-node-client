...
impl KeyValueStoreInfo {
    pub fn new(key_generic_substitution: models::GenericSubstitution, value_generic_substitution: models::GenericSubstitution, allow_ownership: bool) -> KeyValueStoreInfo {
        KeyValueStoreInfo {
