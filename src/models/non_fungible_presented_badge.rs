...
pub struct NonFungiblePresentedBadge {
    #[serde(rename = "type")]
    pub r#type: crate::models::PresentedBadgeType,
...
impl NonFungiblePresentedBadge {
    pub fn new(r#type: crate::models::PresentedBadgeType, resource_address: Option<serde_json::Value>, local_id: String) -> NonFungiblePresentedBadge {
