...
pub struct NetworkConfigurationResponse {
    ...
    pub address_types: Vec<models::AddressType>,
...
impl NetworkConfigurationResponse {
    pub fn new(version: models::NetworkConfigurationResponseVersion, network: String, network_id: i32, network_hrp_suffix: String, usd_price_in_xrd: String, address_types: Vec<models::AddressType>, well_known_addresses: models::NetworkConfigurationResponseWellKnownAddresses) -> NetworkConfigurationResponse {
