...
pub struct ValidatorUptimeCollectionItem {
    ...
    #[serde(rename = "proposals_made", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub proposals_made: Option<Option<i64>>,
    /// number of proposals missed.
    #[serde(rename = "proposals_missed", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl ValidatorUptimeCollectionItem {
    pub fn new(address: String, epochs_active_in: i64) -> ValidatorUptimeCollectionItem {
