...
pub struct TransactionSubmitErrorResponse {
    ...
    pub details: Option<Box<models::TransactionSubmitErrorDetails>>,
}

impl TransactionSubmitErrorResponse {
    pub fn new(error_type: models::ErrorResponseType, code: i32, message: String) -> TransactionSubmitErrorResponse {
