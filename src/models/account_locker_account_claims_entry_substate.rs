...
impl AccountLockerAccountClaimsEntrySubstate {
    pub fn new(substate_type: models::SubstateType, is_locked: bool, key: models::AccountAddressKey, value: models::AccountLockerAccountClaimsEntryValue) -> AccountLockerAccountClaimsEntrySubstate {
