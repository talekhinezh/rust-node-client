...
impl ProtocolUpdateStatusModuleFieldSummarySubstate {
    pub fn new(substate_type: models::SubstateType, is_locked: bool, protocol_version: String, update_status: models::ProtocolUpdateStatus) -> ProtocolUpdateStatusModuleFieldSummarySubstate {
