...
pub struct StateEntityNonFungibleResourceVaultsPageRequest {
    ...
    pub opt_ins: Option<Box<crate::models::StateEntityNonFungibleResourceVaultsPageOptIns>>,
}

impl StateEntityNonFungibleResourceVaultsPageRequest {
    pub fn new(address: String, resource_address: String) -> StateEntityNonFungibleResourceVaultsPageRequest {
