...
impl ProgrammaticScryptoSborValueEnum {
    pub fn new(kind: crate::models::ProgrammaticScryptoSborValueKind, variant_id: i32, fields: Vec<crate::models::ProgrammaticScryptoSborValue>) -> ProgrammaticScryptoSborValueEnum {
