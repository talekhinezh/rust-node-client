...
impl TransactionIntentV2 {
    pub fn new(hash: String, hash_bech32m: String, transaction_header: models::TransactionHeaderV2, root_intent_core: models::IntentCoreV2, non_root_subintents: Vec<models::SubintentV2>) -> TransactionIntentV2 {
        TransactionIntentV2 {
            hash,
            hash_bech32m,
