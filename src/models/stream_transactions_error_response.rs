...
pub struct StreamTransactionsErrorResponse {
    ...
    pub details: Option<Box<models::StreamTransactionsErrorDetails>>,
}

impl StreamTransactionsErrorResponse {
    pub fn new(error_type: models::ErrorResponseType, code: i32, message: String) -> StreamTransactionsErrorResponse {
