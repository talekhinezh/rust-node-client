...
pub struct ObjectInstanceTypeReference {
    #[serde(rename = "type")]
    pub r#type: crate::models::ObjectSubstateTypeReferenceType,
    #[serde(rename = "resolved_full_type_id")]
    pub resolved_full_type_id: Box<crate::models::FullyScopedTypeId>,
...
impl ObjectInstanceTypeReference {
    pub fn new(r#type: crate::models::ObjectSubstateTypeReferenceType, resolved_full_type_id: crate::models::FullyScopedTypeId, generic_index: i32) -> ObjectInstanceTypeReference {
