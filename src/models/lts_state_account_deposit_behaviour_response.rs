...
pub struct LtsStateAccountDepositBehaviourResponse {
    ...
    pub ledger_header_summary: Box<crate::models::LedgerHeaderSummary>,
    #[serde(rename = "default_deposit_rule")]
    pub default_deposit_rule: crate::models::DefaultDepositRule,
    ...
    #[serde(rename = "resource_specific_behaviours", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub resource_specific_behaviours: Option<Option<::std::collections::HashMap<String, crate::models::ResourceSpecificDepositBehaviour>>>,
}

impl LtsStateAccountDepositBehaviourResponse {
    pub fn new(state_version: i64, ledger_header_summary: crate::models::LedgerHeaderSummary, default_deposit_rule: crate::models::DefaultDepositRule) -> LtsStateAccountDepositBehaviourResponse {
