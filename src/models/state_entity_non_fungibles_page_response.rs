...
impl StateEntityNonFungiblesPageResponse {
    pub fn new(ledger_state: crate::models::LedgerState, items: Vec<crate::models::NonFungibleResourcesCollectionItem>, address: String) -> StateEntityNonFungiblesPageResponse {
