...
pub struct StateNonFungibleResponse {
    ...
    pub non_fungible: Box<crate::models::Substate>,
}

impl StateNonFungibleResponse {
    pub fn new(at_ledger_state: crate::models::LedgerStateSummary, non_fungible: crate::models::Substate) -> StateNonFungibleResponse {
