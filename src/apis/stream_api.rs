...
pub async fn stream_transactions(configuration: &configuration::Configuration, stream_transactions_request: crate::models::StreamTransactionsRequest) -> Result<crate::models::StreamTransactionsResponse, Error<StreamTransactionsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StreamTransactionsError> = serde_json::from_str(&local_var_content).ok();
