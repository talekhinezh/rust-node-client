...
pub struct ValidatorFieldStateValue {
    ...
    pub sorted_key: Option<Box<crate::models::SubstateKey>>,
    #[serde(rename = "public_key")]
    pub public_key: Box<crate::models::EcdsaSecp256k1PublicKey>,
    ...
    pub validator_fee_change_request: Option<Box<crate::models::ValidatorFeeChangeRequest>>,
    /// The Bech32m-encoded human readable version of the resource address
    #[serde(rename = "stake_unit_resource_address")]
    pub stake_unit_resource_address: String,
    #[serde(rename = "stake_xrd_vault")]
    pub stake_xrd_vault: Box<crate::models::EntityReference>,
    /// The Bech32m-encoded human readable version of the resource address
    #[serde(rename = "claim_token_resource_address")]
    pub claim_token_resource_address: String,
    #[serde(rename = "pending_xrd_withdraw_vault")]
    pub pending_xrd_withdraw_vault: Box<crate::models::EntityReference>,
    #[serde(rename = "locked_owner_stake_unit_vault")]
    pub locked_owner_stake_unit_vault: Box<crate::models::EntityReference>,
    #[serde(rename = "pending_owner_stake_unit_unlock_vault")]
    pub pending_owner_stake_unit_unlock_vault: Box<crate::models::EntityReference>,
    #[serde(rename = "pending_owner_stake_unit_withdrawals")]
    pub pending_owner_stake_unit_withdrawals: Vec<crate::models::PendingOwnerStakeWithdrawal>,
    /// A string-encoded fixed-precision decimal to 18 decimal places. A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(192 - 1) <= m < 2^(192 - 1)`. 
...
impl ValidatorFieldStateValue {
    pub fn new(public_key: crate::models::EcdsaSecp256k1PublicKey, is_registered: bool, accepts_delegated_stake: bool, validator_fee_factor: String, stake_unit_resource_address: String, stake_xrd_vault: crate::models::EntityReference, claim_token_resource_address: String, pending_xrd_withdraw_vault: crate::models::EntityReference, locked_owner_stake_unit_vault: crate::models::EntityReference, pending_owner_stake_unit_unlock_vault: crate::models::EntityReference, pending_owner_stake_unit_withdrawals: Vec<crate::models::PendingOwnerStakeWithdrawal>, already_unlocked_owner_stake_unit_amount: String) -> ValidatorFieldStateValue {
