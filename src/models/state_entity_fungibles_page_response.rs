...
pub struct StateEntityFungiblesPageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<crate::models::FungibleResourcesCollectionItem>,
...
impl StateEntityFungiblesPageResponse {
    pub fn new(ledger_state: crate::models::LedgerState, items: Vec<crate::models::FungibleResourcesCollectionItem>, address: String) -> StateEntityFungiblesPageResponse {
