...
impl LtsStateAccountFungibleResourceBalanceResponse {
    pub fn new(state_version: i64, ledger_header_summary: models::LedgerHeaderSummary, account_address: String, fungible_resource_balance: models::LtsFungibleResourceBalance) -> LtsStateAccountFungibleResourceBalanceResponse {
