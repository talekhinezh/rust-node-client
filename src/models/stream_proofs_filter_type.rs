...
impl std::fmt::Display for StreamProofsFilterType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Any => write!(f, "Any"),
            Self::NewEpochs => write!(f, "NewEpochs"),
            Self::ProtocolUpdateInitializations => write!(f, "ProtocolUpdateInitializations"),
            Self::ProtocolUpdateExecution => write!(f, "ProtocolUpdateExecution"),
        }
    }
}
