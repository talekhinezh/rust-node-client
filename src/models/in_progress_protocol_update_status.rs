...
pub struct InProgressProtocolUpdateStatus {
    #[serde(rename = "type")]
    pub r#type: models::ProtocolUpdateStatusType,
...
impl InProgressProtocolUpdateStatus {
    pub fn new(r#type: models::ProtocolUpdateStatusType, latest_commit: models::ProtocolUpdateStatusLatestCommit) -> InProgressProtocolUpdateStatus {
