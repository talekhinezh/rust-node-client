...
pub struct FungibleResourcesCollectionItemVaultAggregated {
    ...
    #[serde(rename = "vaults")]
    pub vaults: Box<crate::models::FungibleResourcesCollectionItemVaultAggregatedVault>,
}

impl FungibleResourcesCollectionItemVaultAggregated {
    pub fn new(aggregation_level: crate::models::ResourceAggregationLevel, resource_address: String, vaults: crate::models::FungibleResourcesCollectionItemVaultAggregatedVault) -> FungibleResourcesCollectionItemVaultAggregated {
