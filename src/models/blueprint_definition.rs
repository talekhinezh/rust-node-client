...
pub struct BlueprintDefinition {
    ...
    pub function_exports: std::collections::HashMap<String, models::PackageExport>,
...
impl BlueprintDefinition {
    pub fn new(interface: models::BlueprintInterface, function_exports: std::collections::HashMap<String, models::PackageExport>, hook_exports: Vec<models::HookExport>) -> BlueprintDefinition {
        BlueprintDefinition {
