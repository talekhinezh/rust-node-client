...
pub struct UpdatedSubstate {
    ...
    pub substate_id: Box<crate::models::SubstateId>,
    /// The new value assigned to the substate.
    #[serde(rename = "new_value")]
    pub new_value: Box<crate::models::SubstateValue>,
    ...
    pub previous_value: Option<Box<crate::models::SubstateValue>>,
    /// A structure with type references describing the substate's schema.
    #[serde(rename = "system_structure")]
    pub system_structure: Box<crate::models::SubstateSystemStructure>,
}

impl UpdatedSubstate {
    pub fn new(substate_id: crate::models::SubstateId, new_value: crate::models::SubstateValue, system_structure: crate::models::SubstateSystemStructure) -> UpdatedSubstate {
        UpdatedSubstate {
