...
impl TransactionSubmitRejectedErrorDetails {
    pub fn new(r#type: crate::models::TransactionSubmitErrorDetailsType, error_message: String, is_fresh: bool, is_payload_rejection_permanent: bool, is_intent_rejection_permanent: bool) -> TransactionSubmitRejectedErrorDetails {
