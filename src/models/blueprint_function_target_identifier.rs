...
pub struct BlueprintFunctionTargetIdentifier {
    #[serde(rename = "type")]
    pub r#type: crate::models::TargetIdentifierType,
...
impl BlueprintFunctionTargetIdentifier {
    pub fn new(r#type: crate::models::TargetIdentifierType, package_address: String, blueprint_name: String, function_name: String) -> BlueprintFunctionTargetIdentifier {
