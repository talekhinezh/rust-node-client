...
impl ProtocolUpdateLedgerProofOrigin {
    pub fn new(r#type: models::LedgerProofOriginType, protocol_version_name: String, config_hash: String, batch_group_idx: i64, batch_group_name: String, batch_idx: i64, batch_name: String, is_end_of_update: bool) -> ProtocolUpdateLedgerProofOrigin {
