...
pub struct EncryptedMessageCurveDecryptorSet {
    ...
    pub dh_ephemeral_public_key: Box<crate::models::PublicKey>,
    #[serde(rename = "decryptors")]
    pub decryptors: Vec<crate::models::EncryptedMessageDecryptor>,
}
...
impl EncryptedMessageCurveDecryptorSet {
    ...
    pub fn new(dh_ephemeral_public_key: crate::models::PublicKey, decryptors: Vec<crate::models::EncryptedMessageDecryptor>) -> EncryptedMessageCurveDecryptorSet {
