...
pub struct LtsStateAccountAllFungibleResourceBalancesResponse {
    ...
    pub fungible_resource_balances: Vec<models::LtsFungibleResourceBalance>,
}

impl LtsStateAccountAllFungibleResourceBalancesResponse {
    pub fn new(state_version: i64, ledger_header_summary: models::LedgerHeaderSummary, account_address: String, fungible_resource_balances: Vec<models::LtsFungibleResourceBalance>) -> LtsStateAccountAllFungibleResourceBalancesResponse {
