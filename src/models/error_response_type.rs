...
impl std::fmt::Display for ErrorResponseType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::TransactionSubmit => write!(f, "TransactionSubmit"),
            Self::LtsTransactionSubmit => write!(f, "LtsTransactionSubmit"),
            Self::StreamTransactions => write!(f, "StreamTransactions"),
            Self::StreamProofs => write!(f, "StreamProofs"),
        }
    }
}
