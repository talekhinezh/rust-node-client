...
pub struct EventTypeIdentifier {
    ...
    pub emitter: Box<crate::models::EventEmitterIdentifier>,
    #[serde(rename = "type_reference")]
    pub type_reference: Box<crate::models::PackageTypeReference>,
    #[serde(rename = "name")]
    pub name: String,
}
...
impl EventTypeIdentifier {
    ...
    pub fn new(emitter: crate::models::EventEmitterIdentifier, type_reference: crate::models::PackageTypeReference, name: String) -> EventTypeIdentifier {
        EventTypeIdentifier {
