...
pub struct LedgerHeader {
    ...
    #[serde(rename = "hashes")]
    pub hashes: Box<crate::models::LedgerHashes>,
    ...
    pub next_epoch: Option<Box<crate::models::NextEpoch>>,
}

impl LedgerHeader {
    pub fn new(epoch: i64, round: i64, state_version: i64, hashes: crate::models::LedgerHashes, consensus_parent_round_timestamp_ms: i64, proposer_timestamp_ms: i64) -> LedgerHeader {
        LedgerHeader {
            epoch,
            round,
            state_version,
