...
pub struct StatePackageResponse {
    ...
    pub royalty: Option<Box<crate::models::Substate>>,
}

impl StatePackageResponse {
    pub fn new(at_ledger_state: crate::models::LedgerStateSummary, owner_role: crate::models::Substate) -> StatePackageResponse {
