...
impl StateConsensusManagerResponse {
    pub fn new(at_ledger_state: models::LedgerStateSummary, config: models::Substate, state: models::Substate, current_proposal_statistic: models::Substate, current_validator_set: models::Substate, current_time: models::Substate, current_time_rounded_to_minutes: models::Substate) -> StateConsensusManagerResponse {
