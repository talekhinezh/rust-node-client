...
impl PackageCodeOriginalCodeEntrySubstate {
    pub fn new(substate_type: models::SubstateType, is_locked: bool, key: models::PackageCodeKey, value: models::PackageCodeOriginalCodeEntryValue) -> PackageCodeOriginalCodeEntrySubstate {
