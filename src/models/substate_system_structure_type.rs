...
impl std::fmt::Display for SubstateSystemStructureType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::SystemField => write!(f, "SystemField"),
            Self::SystemSchema => write!(f, "SystemSchema"),
            Self::KeyValueStoreEntry => write!(f, "KeyValueStoreEntry"),
            Self::ObjectField => write!(f, "ObjectField"),
            Self::ObjectKeyValuePartitionEntry => write!(f, "ObjectKeyValuePartitionEntry"),
            Self::ObjectIndexPartitionEntry => write!(f, "ObjectIndexPartitionEntry"),
            Self::ObjectSortedIndexPartitionEntry => write!(f, "ObjectSortedIndexPartitionEntry"),
        }
    }
}
