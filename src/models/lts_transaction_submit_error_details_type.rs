...
impl std::fmt::Display for LtsTransactionSubmitErrorDetailsType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::PriorityThresholdNotMet => write!(f, "PriorityThresholdNotMet"),
            Self::IntentAlreadyCommitted => write!(f, "IntentAlreadyCommitted"),
