...
pub struct RecoveryRoleRecoveryAttempt {
    ...
    pub recovery_proposal: Box<crate::models::RecoveryProposal>,
    ...
    pub timed_recovery_allowed_after: Option<Box<crate::models::Instant>>,
}

impl RecoveryRoleRecoveryAttempt {
    pub fn new(recovery_proposal: crate::models::RecoveryProposal) -> RecoveryRoleRecoveryAttempt {
