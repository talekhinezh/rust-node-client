...
impl SignedTransactionIntent {
    pub fn new(hash: String, hash_bech32m: String, intent: models::TransactionIntent, intent_signatures: Vec<models::SignatureWithPublicKey>) -> SignedTransactionIntent {
