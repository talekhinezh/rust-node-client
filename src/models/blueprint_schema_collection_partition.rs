...
pub struct BlueprintSchemaCollectionPartition {
    ...
    pub partition_description: Box<crate::models::PartitionDescription>,
    #[serde(rename = "collection_schema")]
    pub collection_schema: Box<crate::models::BlueprintCollectionSchema>,
}

impl BlueprintSchemaCollectionPartition {
    /// The fields partition of the blueprint.
    pub fn new(partition_description: crate::models::PartitionDescription, collection_schema: crate::models::BlueprintCollectionSchema) -> BlueprintSchemaCollectionPartition {
