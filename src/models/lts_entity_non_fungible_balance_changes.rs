...
pub struct LtsEntityNonFungibleBalanceChanges {
    ...
    #[serde(rename = "removed", deserialize_with = "Option::deserialize")]
    pub removed: Option<serde_json::Value>,
}

impl LtsEntityNonFungibleBalanceChanges {
    pub fn new(entity_address: String, resource_address: String, added: Vec<String>, removed: Option<serde_json::Value>) -> LtsEntityNonFungibleBalanceChanges {
