...
pub struct LtsTransactionPayloadDetails {
    ...
    #[serde(rename = "status")]
    pub status: crate::models::LtsTransactionPayloadStatus,
...
impl LtsTransactionPayloadDetails {
    pub fn new(payload_hash: String, payload_hash_bech32m: String, status: crate::models::LtsTransactionPayloadStatus) -> LtsTransactionPayloadDetails {
