...
pub struct NotarizedTransaction {
    ...
    pub signed_intent: Box<crate::models::SignedTransactionIntent>,
    #[serde(rename = "notary_signature")]
    pub notary_signature: Box<crate::models::Signature>,
}

impl NotarizedTransaction {
    pub fn new(hash: String, hash_bech32m: String, signed_intent: crate::models::SignedTransactionIntent, notary_signature: crate::models::Signature) -> NotarizedTransaction {
