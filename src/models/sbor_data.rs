...
pub struct SborData {
    ...
    #[serde(rename = "programmatic_json", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub programmatic_json: Option<Option<serde_json::Value>>,
}
