...
pub struct BlueprintInterface {
    ...
    pub generic_type_parameters: Vec<models::GenericTypeParameter>,
    ...
    pub functions: std::collections::HashMap<String, models::FunctionSchema>,
    /// A map from the event name to the event payload type reference.
    #[serde(rename = "events")]
    pub events: std::collections::HashMap<String, models::BlueprintPayloadDef>,
...
impl BlueprintInterface {
    pub fn new(generic_type_parameters: Vec<models::GenericTypeParameter>, is_transient: bool, features: Vec<String>, state: models::IndexedStateSchema, functions: std::collections::HashMap<String, models::FunctionSchema>, events: std::collections::HashMap<String, models::BlueprintPayloadDef>, types: std::collections::HashMap<String, models::ScopedTypeId>) -> BlueprintInterface {
        BlueprintInterface {
