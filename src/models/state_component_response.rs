...
impl StateComponentResponse {
    pub fn new(at_ledger_state: models::LedgerStateSummary, info: models::Substate, state: models::Substate, owner_role: models::Substate, vaults: Vec<models::VaultBalance>, descendent_nodes: Vec<models::StateComponentDescendentNode>) -> StateComponentResponse {
