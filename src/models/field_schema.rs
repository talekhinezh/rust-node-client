...
pub struct FieldSchema {
    ...
    pub field_type_ref: Box<crate::models::BlueprintPayloadDef>,
    #[serde(rename = "condition", skip_serializing_if = "Option::is_none")]
    pub condition: Option<Box<crate::models::FieldSchemaFeatureCondition>>,
...
impl FieldSchema {
    pub fn new(field_type_ref: crate::models::BlueprintPayloadDef) -> FieldSchema {
        FieldSchema {
