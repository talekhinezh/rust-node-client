...
pub struct MempoolTransactionResponse {
    ...
    pub payloads: Vec<models::MempoolTransactionResponsePayloadsInner>,
}

impl MempoolTransactionResponse {
    pub fn new(count: i32, payloads: Vec<models::MempoolTransactionResponsePayloadsInner>) -> MempoolTransactionResponse {
