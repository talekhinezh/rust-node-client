...
impl TimestampedValidatorSignature {
    pub fn new(validator_key: models::EcdsaSecp256k1PublicKey, validator_address: String, timestamp_ms: i64, signature: models::EcdsaSecp256k1Signature) -> TimestampedValidatorSignature {
