...
pub struct ProgrammaticScryptoSborValueMap {
    ...
    #[serde(rename = "value_type_name", skip_serializing_if = "Option::is_none")]
...
impl ProgrammaticScryptoSborValueMap {
    pub fn new(kind: crate::models::ProgrammaticScryptoSborValueKind, key_kind: crate::models::ProgrammaticScryptoSborValueKind, value_kind: crate::models::ProgrammaticScryptoSborValueKind, entries: Vec<crate::models::ProgrammaticScryptoSborValueMapEntry>) -> ProgrammaticScryptoSborValueMap {
