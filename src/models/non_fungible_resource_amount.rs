...
impl NonFungibleResourceAmount {
    pub fn new(resource_type: models::ResourceType, resource_address: String, amount: String, non_fungible_ids: Vec<models::NonFungibleLocalId>) -> NonFungibleResourceAmount {
