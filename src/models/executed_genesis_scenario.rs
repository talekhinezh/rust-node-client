...
pub struct ExecutedGenesisScenario {
    ...
    pub committed_transactions: Vec<crate::models::ExecutedScenarioTransaction>,
    /// Well-named addresses touched/created by the Scenario, keyed by their name. 
    #[serde(rename = "addresses", deserialize_with = "Option::deserialize")]
    pub addresses: Option<::std::collections::HashMap<String, String>>,
}

impl ExecutedGenesisScenario {
    pub fn new(sequence_number: i32, logical_name: String, committed_transactions: Vec<crate::models::ExecutedScenarioTransaction>, addresses: Option<::std::collections::HashMap<String, String>>) -> ExecutedGenesisScenario {
