...
pub struct ComponentEntityRoleAssignmentEntry {
    ...
    pub assignment: Box<crate::models::ComponentEntityRoleAssignmentEntryAssignment>,
...
impl ComponentEntityRoleAssignmentEntry {
    pub fn new(role_key: crate::models::RoleKey, assignment: crate::models::ComponentEntityRoleAssignmentEntryAssignment) -> ComponentEntityRoleAssignmentEntry {
