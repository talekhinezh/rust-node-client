...
pub struct NonFungibleResourceManagerFieldMutableFieldsValue {
    ...
    pub mutable_fields: Vec<crate::models::MutableField>,
}

impl NonFungibleResourceManagerFieldMutableFieldsValue {
    pub fn new(mutable_fields: Vec<crate::models::MutableField>) -> NonFungibleResourceManagerFieldMutableFieldsValue {
