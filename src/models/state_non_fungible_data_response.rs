...
pub struct StateNonFungibleDataResponse {
    ...
    pub non_fungible_ids: Vec<crate::models::StateNonFungibleDetailsResponseItem>,
}

impl StateNonFungibleDataResponse {
    pub fn new(ledger_state: crate::models::LedgerState, resource_address: String, non_fungible_id_type: crate::models::NonFungibleIdType, non_fungible_ids: Vec<crate::models::StateNonFungibleDetailsResponseItem>) -> StateNonFungibleDataResponse {
