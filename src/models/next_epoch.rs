...
pub struct NextEpoch {
    ...
    pub validators: Vec<models::ActiveValidator>,
    #[serde(rename = "significant_protocol_update_readiness", skip_serializing_if = "Option::is_none")]
    pub significant_protocol_update_readiness: Option<Vec<models::SignificantProtocolUpdateReadinessEntry>>,
}

impl NextEpoch {
    pub fn new(epoch: i64, validators: Vec<models::ActiveValidator>) -> NextEpoch {
        NextEpoch {
            epoch,
            validators,
