...
impl StateNonFungibleIdsResponse {
    pub fn new(ledger_state: crate::models::LedgerState, resource_address: String, non_fungible_ids: crate::models::NonFungibleIdsCollection) -> StateNonFungibleIdsResponse {
