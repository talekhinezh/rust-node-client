...
pub struct EcdsaSecp256k1SignatureWithPublicKey {
    ...
    pub recoverable_signature: Box<crate::models::EcdsaSecp256k1Signature>,
}

impl EcdsaSecp256k1SignatureWithPublicKey {
    pub fn new(key_type: crate::models::PublicKeyType, recoverable_signature: crate::models::EcdsaSecp256k1Signature) -> EcdsaSecp256k1SignatureWithPublicKey {
