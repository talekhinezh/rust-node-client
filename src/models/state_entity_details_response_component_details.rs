...
pub struct StateEntityDetailsResponseComponentDetails {
    ...
    pub role_assignments: Option<Box<crate::models::ComponentEntityRoleAssignments>>,
...
impl StateEntityDetailsResponseComponentDetails {
    pub fn new(r#type: crate::models::StateEntityDetailsResponseItemDetailsType, blueprint_name: String, blueprint_version: String) -> StateEntityDetailsResponseComponentDetails {
