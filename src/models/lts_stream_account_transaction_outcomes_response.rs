...
pub struct LtsStreamAccountTransactionOutcomesResponse {
    ...
    pub committed_transaction_outcomes: Vec<crate::models::LtsCommittedTransactionOutcome>,
}

impl LtsStreamAccountTransactionOutcomesResponse {
    pub fn new(from_state_version: i64, count: i32, max_ledger_state_version: i64, committed_transaction_outcomes: Vec<crate::models::LtsCommittedTransactionOutcome>) -> LtsStreamAccountTransactionOutcomesResponse {
