...
impl IndexBlueprintCollectionSchema {
    pub fn new(r#type: models::BlueprintCollectionSchemaType, key_type_ref: models::BlueprintPayloadDef, value_type_ref: models::BlueprintPayloadDef, allow_ownership: bool) -> IndexBlueprintCollectionSchema {
