...
pub struct StateEntityDetailsResponseItem {
    ...
    pub fungible_resources: Option<Box<crate::models::FungibleResourcesCollection>>,
    #[serde(rename = "non_fungible_resources", skip_serializing_if = "Option::is_none")]
    pub non_fungible_resources: Option<Box<crate::models::NonFungibleResourcesCollection>>,
    #[serde(rename = "ancestor_identities", skip_serializing_if = "Option::is_none")]
    pub ancestor_identities: Option<Box<crate::models::StateEntityDetailsResponseItemAncestorIdentities>>,
    ...
    pub details: Option<Box<crate::models::StateEntityDetailsResponseItemDetails>>,
}

impl StateEntityDetailsResponseItem {
    pub fn new(address: String, metadata: crate::models::EntityMetadataCollection) -> StateEntityDetailsResponseItem {
