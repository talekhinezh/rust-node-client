...
pub struct LedgerStateSummary {
    ...
    pub header_summary: Box<crate::models::LedgerHeaderSummary>,
}

impl LedgerStateSummary {
    pub fn new(state_version: i64, header_summary: crate::models::LedgerHeaderSummary) -> LedgerStateSummary {
        LedgerStateSummary {
            state_version,
