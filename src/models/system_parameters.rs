...
impl SystemParameters {
    pub fn new(network_definition: models::NetworkDefinition, costing_module_config: models::CostingModuleConfig, costing_parameters: models::SystemCostingParameters, limit_parameters: models::LimitParameters) -> SystemParameters {
        SystemParameters {
