...
pub struct StateEntityFungibleResourceVaultsPageResponse {
    ...
    #[serde(rename = "items")]
    pub items: Vec<crate::models::FungibleResourcesCollectionItemVaultAggregatedVaultItem>,
...
impl StateEntityFungibleResourceVaultsPageResponse {
    pub fn new(ledger_state: crate::models::LedgerState, items: Vec<crate::models::FungibleResourcesCollectionItemVaultAggregatedVaultItem>, address: String, resource_address: String) -> StateEntityFungibleResourceVaultsPageResponse {
