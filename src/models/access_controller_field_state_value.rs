...
pub struct AccessControllerFieldStateValue {
    ...
    pub controlled_vault: Box<crate::models::EntityReference>,
    ...
    pub primary_role_recovery_attempt: Option<Box<crate::models::PrimaryRoleRecoveryAttempt>>,
    ...
    pub recovery_role_recovery_attempt: Option<Box<crate::models::RecoveryRoleRecoveryAttempt>>,
...
impl AccessControllerFieldStateValue {
    pub fn new(controlled_vault: crate::models::EntityReference, recovery_badge_resource_address: String, is_primary_role_locked: bool, has_primary_role_badge_withdraw_attempt: bool, has_recovery_role_badge_withdraw_attempt: bool) -> AccessControllerFieldStateValue {
