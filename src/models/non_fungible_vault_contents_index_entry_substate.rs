...
impl NonFungibleVaultContentsIndexEntrySubstate {
    pub fn new(substate_type: models::SubstateType, is_locked: bool, key: models::LocalNonFungibleKey, value: models::NonFungibleVaultContentsIndexEntryValue) -> NonFungibleVaultContentsIndexEntrySubstate {
