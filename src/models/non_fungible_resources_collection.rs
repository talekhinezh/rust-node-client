...
/// NonFungibleResourcesCollection : Non-fungible resources collection.
...
impl NonFungibleResourcesCollection {
    ...
    pub fn new(items: Vec<crate::models::NonFungibleResourcesCollectionItem>) -> NonFungibleResourcesCollection {
