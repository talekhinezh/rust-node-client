...
pub struct PaymentToRoyaltyRecipient {
    ...
    pub royalty_recipient: Box<crate::models::EntityReference>,
...
impl PaymentToRoyaltyRecipient {
    pub fn new(royalty_recipient: crate::models::EntityReference, xrd_amount: String) -> PaymentToRoyaltyRecipient {
