...
pub struct PackageBlueprintRoyaltyEntryValue {
    ...
    pub royalty_config: Box<crate::models::BlueprintRoyaltyConfig>,
}

impl PackageBlueprintRoyaltyEntryValue {
    pub fn new(royalty_config: crate::models::BlueprintRoyaltyConfig) -> PackageBlueprintRoyaltyEntryValue {
