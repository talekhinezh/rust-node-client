...
pub struct ProposerReward {
    ...
    pub validator_index: Box<crate::models::ActiveValidatorIndex>,
...
impl ProposerReward {
    pub fn new(validator_index: crate::models::ActiveValidatorIndex, xrd_amount: String) -> ProposerReward {
        ProposerReward {
