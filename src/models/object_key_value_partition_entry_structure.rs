...
impl ObjectKeyValuePartitionEntryStructure {
    pub fn new(r#type: models::SubstateSystemStructureType, key_schema: models::ObjectSubstateTypeReference, value_schema: models::ObjectSubstateTypeReference) -> ObjectKeyValuePartitionEntryStructure {
