...
impl StateKeyValueStoreDataResponse {
    pub fn new(ledger_state: crate::models::LedgerState, key_value_store_address: String, entries: Vec<crate::models::StateKeyValueStoreDataResponseItem>) -> StateKeyValueStoreDataResponse {
