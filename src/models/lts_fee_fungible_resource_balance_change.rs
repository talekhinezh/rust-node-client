...
pub struct LtsFeeFungibleResourceBalanceChange {
    #[serde(rename = "type")]
    pub r#type: models::LtsFeeFungibleResourceBalanceChangeType,
...
impl LtsFeeFungibleResourceBalanceChange {
    pub fn new(r#type: models::LtsFeeFungibleResourceBalanceChangeType, resource_address: String, balance_change: String) -> LtsFeeFungibleResourceBalanceChange {
