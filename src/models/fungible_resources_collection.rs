...
/// FungibleResourcesCollection : Fungible resources collection.
...
impl FungibleResourcesCollection {
    ...
    pub fn new(items: Vec<crate::models::FungibleResourcesCollectionItem>) -> FungibleResourcesCollection {
