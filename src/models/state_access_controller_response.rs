...
impl StateAccessControllerResponse {
    pub fn new(at_ledger_state: models::LedgerStateSummary, state: models::Substate, owner_role: models::Substate, vaults: Vec<models::VaultBalance>, descendent_nodes: Vec<models::StateComponentDescendentNode>) -> StateAccessControllerResponse {
