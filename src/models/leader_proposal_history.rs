...
pub struct LeaderProposalHistory {
    ...
    pub gap_round_leaders: Vec<crate::models::ActiveValidatorIndex>,
    /// The leader of the concluded round.
    #[serde(rename = "current_leader")]
    pub current_leader: Box<crate::models::ActiveValidatorIndex>,
...
impl LeaderProposalHistory {
    pub fn new(gap_round_leaders: Vec<crate::models::ActiveValidatorIndex>, current_leader: crate::models::ActiveValidatorIndex, is_fallback: bool) -> LeaderProposalHistory {
