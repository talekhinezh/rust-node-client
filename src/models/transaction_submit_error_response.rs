...
pub struct TransactionSubmitErrorResponse {
    ...
    pub details: Option<Box<crate::models::TransactionSubmitErrorDetails>>,
}

impl TransactionSubmitErrorResponse {
    pub fn new(error_type: crate::models::ErrorResponseType, code: Option<serde_json::Value>, message: Option<serde_json::Value>) -> TransactionSubmitErrorResponse {
