...
pub struct AuthConfig {
    ...
    pub function_auth_type: models::FunctionAuthType,
    ...
    pub function_access_rules: Option<std::collections::HashMap<String, models::AccessRule>>,
...
impl AuthConfig {
    pub fn new(function_auth_type: models::FunctionAuthType, method_auth_type: models::MethodAuthType) -> AuthConfig {
        AuthConfig {
            function_auth_type,
