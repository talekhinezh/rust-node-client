...
pub struct ConsensusManagerRegisteredValidatorsByStakeIndexEntryValue {
    ...
    pub active_validator: Box<crate::models::ActiveValidator>,
}

impl ConsensusManagerRegisteredValidatorsByStakeIndexEntryValue {
    pub fn new(active_validator: crate::models::ActiveValidator) -> ConsensusManagerRegisteredValidatorsByStakeIndexEntryValue {
