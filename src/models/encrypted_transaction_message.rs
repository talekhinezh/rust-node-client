...
pub struct EncryptedTransactionMessage {
    #[serde(rename = "type")]
    pub r#type: crate::models::TransactionMessageType,
    ...
    pub curve_decryptor_sets: Vec<crate::models::EncryptedMessageCurveDecryptorSet>,
}

impl EncryptedTransactionMessage {
    pub fn new(r#type: crate::models::TransactionMessageType, encrypted_hex: String, curve_decryptor_sets: Vec<crate::models::EncryptedMessageCurveDecryptorSet>) -> EncryptedTransactionMessage {
