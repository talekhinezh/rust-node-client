...
pub struct GenesisLedgerTransaction {
    ...
    pub system_transaction: Option<Box<crate::models::SystemTransaction>>,
}

impl GenesisLedgerTransaction {
    pub fn new(r#type: crate::models::LedgerTransactionType, is_flash: bool) -> GenesisLedgerTransaction {
