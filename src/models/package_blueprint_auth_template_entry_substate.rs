...
impl PackageBlueprintAuthTemplateEntrySubstate {
    pub fn new(substate_type: models::SubstateType, is_locked: bool, key: models::BlueprintVersionKey, value: models::PackageBlueprintAuthTemplateEntryValue) -> PackageBlueprintAuthTemplateEntrySubstate {
