...
impl TransactionTrackerCollectionEntrySubstate {
    pub fn new(substate_type: models::SubstateType, is_locked: bool, key: models::TransactionIdKey, value: models::TransactionTrackerCollectionEntryValue) -> TransactionTrackerCollectionEntrySubstate {
