...
pub struct SubstateId {
    ...
    pub entity_module: models::EntityModule,
    #[serde(rename = "partition_kind")]
    pub partition_kind: models::PartitionKind,
...
impl SubstateId {
    pub fn new(entity_type: models::EntityType, entity_address: String, entity_module: models::EntityModule, partition_kind: models::PartitionKind, partition_number: i32, substate_type: models::SubstateType, substate_key: models::SubstateKey) -> SubstateId {
        SubstateId {
            entity_type,
            entity_address,
            entity_module,
