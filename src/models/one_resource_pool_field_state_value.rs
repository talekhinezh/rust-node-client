...
pub struct OneResourcePoolFieldStateValue {
    #[serde(rename = "vault")]
    pub vault: Box<crate::models::EntityReference>,
...
impl OneResourcePoolFieldStateValue {
    pub fn new(vault: crate::models::EntityReference, pool_unit_resource_address: String) -> OneResourcePoolFieldStateValue {
