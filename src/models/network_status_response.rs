...
pub struct NetworkStatusResponse {
    ...
    pub pre_genesis_state_identifier: Box<crate::models::CommittedStateIdentifier>,
    ...
    pub genesis_epoch_round: Option<Box<crate::models::EpochRound>>,
    ...
    pub post_genesis_state_identifier: Option<Box<crate::models::CommittedStateIdentifier>>,
    /// The post-genesis epoch and round. 
    #[serde(rename = "post_genesis_epoch_round", skip_serializing_if = "Option::is_none")]
    pub post_genesis_epoch_round: Option<Box<crate::models::EpochRound>>,
    ...
    pub current_state_identifier: Option<Box<crate::models::CommittedStateIdentifier>>,
    ...
    pub current_epoch_round: Option<Box<crate::models::EpochRound>>,
...
impl NetworkStatusResponse {
    pub fn new(pre_genesis_state_identifier: crate::models::CommittedStateIdentifier, current_protocol_version: String) -> NetworkStatusResponse {
