...
pub struct TransactionIntent {
    ...
    #[serde(rename = "header")]
    pub header: Box<crate::models::TransactionHeader>,
    ...
    #[serde(rename = "blobs_hex", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub blobs_hex: Option<Option<::std::collections::HashMap<String, String>>>,
    ...
    pub message: Option<Box<crate::models::TransactionMessage>>,
}

impl TransactionIntent {
    pub fn new(hash: String, hash_bech32m: String, header: crate::models::TransactionHeader) -> TransactionIntent {
        TransactionIntent {
            hash,
            hash_bech32m,
