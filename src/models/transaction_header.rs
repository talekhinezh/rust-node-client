...
pub struct TransactionHeader {
    ...
    pub notary_public_key: Box<crate::models::PublicKey>,
...
impl TransactionHeader {
    pub fn new(network_id: i32, start_epoch_inclusive: i64, end_epoch_exclusive: i64, nonce: i64, notary_public_key: crate::models::PublicKey, notary_is_signatory: bool, tip_percentage: i32) -> TransactionHeader {
        TransactionHeader {
            network_id,
