...
pub struct StateEntityDetailsResponsePackageDetailsSchemaCollection {
    ...
    #[serde(rename = "items")]
    pub items: Vec<crate::models::StateEntityDetailsResponsePackageDetailsSchemaItem>,
}

impl StateEntityDetailsResponsePackageDetailsSchemaCollection {
    pub fn new(items: Vec<crate::models::StateEntityDetailsResponsePackageDetailsSchemaItem>) -> StateEntityDetailsResponsePackageDetailsSchemaCollection {
