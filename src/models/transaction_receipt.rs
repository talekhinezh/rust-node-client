...
impl TransactionReceipt {
    ...
    pub fn new(status: models::TransactionStatus, fee_summary: models::FeeSummary, costing_parameters: models::CostingParameters, state_updates: models::StateUpdates) -> TransactionReceipt {
        TransactionReceipt {
            status,
