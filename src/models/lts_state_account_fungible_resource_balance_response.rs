...
pub struct LtsStateAccountFungibleResourceBalanceResponse {
    ...
    pub fungible_resource_balance: Box<crate::models::LtsFungibleResourceBalance>,
}

impl LtsStateAccountFungibleResourceBalanceResponse {
    pub fn new(state_version: i64, ledger_header_summary: crate::models::LedgerHeaderSummary, account_address: String, fungible_resource_balance: crate::models::LtsFungibleResourceBalance) -> LtsStateAccountFungibleResourceBalanceResponse {
