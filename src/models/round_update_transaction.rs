...
pub struct RoundUpdateTransaction {
    ...
    pub leader_proposal_history: Box<crate::models::LeaderProposalHistory>,
}

impl RoundUpdateTransaction {
    pub fn new(proposer_timestamp: crate::models::Instant, epoch: i64, round_in_epoch: i64, leader_proposal_history: crate::models::LeaderProposalHistory) -> RoundUpdateTransaction {
