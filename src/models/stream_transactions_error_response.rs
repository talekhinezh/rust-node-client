...
pub struct StreamTransactionsErrorResponse {
    ...
    pub details: Option<Box<crate::models::StreamTransactionsErrorDetails>>,
}

impl StreamTransactionsErrorResponse {
    pub fn new(error_type: crate::models::ErrorResponseType, code: Option<serde_json::Value>, message: Option<serde_json::Value>) -> StreamTransactionsErrorResponse {
