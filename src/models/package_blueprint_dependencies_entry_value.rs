...
pub struct PackageBlueprintDependenciesEntryValue {
    ...
    pub dependencies: Box<crate::models::BlueprintDependencies>,
}

impl PackageBlueprintDependenciesEntryValue {
    pub fn new(dependencies: crate::models::BlueprintDependencies) -> PackageBlueprintDependenciesEntryValue {
