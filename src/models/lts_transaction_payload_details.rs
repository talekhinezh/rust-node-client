...
pub struct LtsTransactionPayloadDetails {
    ...
    #[serde(rename = "status")]
    pub status: models::LtsTransactionPayloadStatus,
...
impl LtsTransactionPayloadDetails {
    pub fn new(payload_hash: String, payload_hash_bech32m: String, status: models::LtsTransactionPayloadStatus) -> LtsTransactionPayloadDetails {
