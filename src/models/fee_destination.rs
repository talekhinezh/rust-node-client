...
pub struct FeeDestination {
    ...
    pub to_royalty_recipients: Vec<models::PaymentToRoyaltyRecipient>,
}

impl FeeDestination {
    pub fn new(to_proposer: String, to_validator_set: String, to_burn: String, to_royalty_recipients: Vec<models::PaymentToRoyaltyRecipient>) -> FeeDestination {
        FeeDestination {
            to_proposer,
            to_validator_set,
            to_burn,
