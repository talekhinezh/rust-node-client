...
impl StateEntityNonFungibleResourceVaultsPageResponse {
    pub fn new(ledger_state: crate::models::LedgerState, items: Vec<crate::models::NonFungibleResourcesCollectionItemVaultAggregatedVaultItem>, address: String, resource_address: String) -> StateEntityNonFungibleResourceVaultsPageResponse {
