...
pub struct UserLedgerTransactionV2 {
    ...
    pub notarized_transaction: Box<models::NotarizedTransactionV2>,
}

impl UserLedgerTransactionV2 {
    pub fn new(r#type: models::LedgerTransactionType, notarized_transaction: models::NotarizedTransactionV2) -> UserLedgerTransactionV2 {
