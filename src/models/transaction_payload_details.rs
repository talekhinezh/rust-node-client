...
pub struct TransactionPayloadDetails {
    ...
    #[serde(rename = "status")]
    pub status: models::TransactionPayloadStatus,
...
impl TransactionPayloadDetails {
    pub fn new(payload_hash: String, payload_hash_bech32m: String, status: models::TransactionPayloadStatus) -> TransactionPayloadDetails {
