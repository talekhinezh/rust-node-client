...
pub struct PlaintextTransactionMessage {
    ...
    pub content: Box<crate::models::PlaintextMessageContent>,
}

impl PlaintextTransactionMessage {
    pub fn new(r#type: crate::models::TransactionMessageType, mime_type: String, content: crate::models::PlaintextMessageContent) -> PlaintextTransactionMessage {
