...
pub struct ExecutedScenario {
    ...
    pub committed_transactions: Vec<models::ExecutedScenarioTransaction>,
...
impl ExecutedScenario {
    pub fn new(sequence_number: i32, logical_name: String, committed_transactions: Vec<models::ExecutedScenarioTransaction>, addresses: std::collections::HashMap<String, String>) -> ExecutedScenario {
        ExecutedScenario {
            sequence_number,
            logical_name,
