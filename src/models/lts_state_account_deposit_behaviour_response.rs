...
pub struct LtsStateAccountDepositBehaviourResponse {
    ...
    pub default_deposit_rule: models::DefaultDepositRule,
...
impl LtsStateAccountDepositBehaviourResponse {
    pub fn new(state_version: i64, ledger_header_summary: models::LedgerHeaderSummary, default_deposit_rule: models::DefaultDepositRule) -> LtsStateAccountDepositBehaviourResponse {
