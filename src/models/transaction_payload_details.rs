...
pub struct TransactionPayloadDetails {
    ...
    #[serde(rename = "status")]
    pub status: crate::models::TransactionPayloadStatus,
...
impl TransactionPayloadDetails {
    pub fn new(payload_hash: String, payload_hash_bech32m: String, status: crate::models::TransactionPayloadStatus) -> TransactionPayloadDetails {
