...
impl NonFungibleResourceManagerFieldIdTypeSubstate {
    pub fn new(substate_type: models::SubstateType, is_locked: bool, value: models::NonFungibleResourceManagerFieldIdTypeValue) -> NonFungibleResourceManagerFieldIdTypeSubstate {
