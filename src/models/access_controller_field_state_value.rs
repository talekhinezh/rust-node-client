...
impl AccessControllerFieldStateValue {
    pub fn new(controlled_vault: models::EntityReference, recovery_badge_resource_address: String, is_primary_role_locked: bool, has_primary_role_badge_withdraw_attempt: bool, has_recovery_role_badge_withdraw_attempt: bool) -> AccessControllerFieldStateValue {
