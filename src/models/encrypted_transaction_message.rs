...
impl EncryptedTransactionMessage {
    pub fn new(r#type: models::TransactionMessageType, encrypted_hex: String, curve_decryptor_sets: Vec<models::EncryptedMessageCurveDecryptorSet>) -> EncryptedTransactionMessage {
