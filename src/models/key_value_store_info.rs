...
pub struct KeyValueStoreInfo {
    ...
    pub key_generic_substitution: Box<crate::models::GenericSubstitution>,
    #[serde(rename = "value_generic_substitution")]
    pub value_generic_substitution: Box<crate::models::GenericSubstitution>,
...
impl KeyValueStoreInfo {
    pub fn new(key_generic_substitution: crate::models::GenericSubstitution, value_generic_substitution: crate::models::GenericSubstitution, allow_ownership: bool) -> KeyValueStoreInfo {
        KeyValueStoreInfo {
