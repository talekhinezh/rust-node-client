...
pub struct LtsStateAccountAllFungibleResourceBalancesResponse {
    ...
    pub fungible_resource_balances: Vec<crate::models::LtsFungibleResourceBalance>,
}

impl LtsStateAccountAllFungibleResourceBalancesResponse {
    pub fn new(state_version: i64, ledger_header_summary: crate::models::LedgerHeaderSummary, account_address: String, fungible_resource_balances: Vec<crate::models::LtsFungibleResourceBalance>) -> LtsStateAccountAllFungibleResourceBalancesResponse {
