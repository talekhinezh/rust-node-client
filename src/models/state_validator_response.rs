...
impl StateValidatorResponse {
    pub fn new(at_ledger_state: models::LedgerStateSummary, address: String, state: models::Substate, protocol_update_readiness_signal: models::Substate, owner_role: models::Substate, vaults: Vec<models::VaultBalance>, descendent_nodes: Vec<models::StateComponentDescendentNode>) -> StateValidatorResponse {
