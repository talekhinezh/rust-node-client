...
pub struct LtsResultantAccountFungibleBalances {
    ...
    pub resultant_balances: Vec<crate::models::LtsResultantFungibleBalance>,
}

impl LtsResultantAccountFungibleBalances {
    pub fn new(account_address: String, resultant_balances: Vec<crate::models::LtsResultantFungibleBalance>) -> LtsResultantAccountFungibleBalances {
