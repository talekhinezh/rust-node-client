...
pub struct LtsCommittedTransactionOutcome {
    ...
    pub user_transaction_identifiers: Option<Box<crate::models::TransactionIdentifiers>>,
    #[serde(rename = "status")]
    pub status: crate::models::LtsCommittedTransactionStatus,
    #[serde(rename = "fungible_entity_balance_changes")]
    pub fungible_entity_balance_changes: Vec<crate::models::LtsEntityFungibleBalanceChanges>,
    #[serde(rename = "non_fungible_entity_balance_changes")]
    pub non_fungible_entity_balance_changes: Vec<crate::models::LtsEntityNonFungibleBalanceChanges>,
    #[serde(rename = "resultant_account_fungible_balances")]
    pub resultant_account_fungible_balances: Vec<crate::models::LtsResultantAccountFungibleBalances>,
...
impl LtsCommittedTransactionOutcome {
    ...
    pub fn new(state_version: i64, proposer_timestamp_ms: i64, accumulator_hash: String, status: crate::models::LtsCommittedTransactionStatus, fungible_entity_balance_changes: Vec<crate::models::LtsEntityFungibleBalanceChanges>, non_fungible_entity_balance_changes: Vec<crate::models::LtsEntityNonFungibleBalanceChanges>, resultant_account_fungible_balances: Vec<crate::models::LtsResultantAccountFungibleBalances>, total_fee: String) -> LtsCommittedTransactionOutcome {
