...
pub struct NonFungibleResourcesCollectionItemVaultAggregated {
    ...
    #[serde(rename = "vaults")]
    pub vaults: Box<crate::models::NonFungibleResourcesCollectionItemVaultAggregatedVault>,
}

impl NonFungibleResourcesCollectionItemVaultAggregated {
    pub fn new(aggregation_level: crate::models::ResourceAggregationLevel, resource_address: String, vaults: crate::models::NonFungibleResourcesCollectionItemVaultAggregatedVault) -> NonFungibleResourcesCollectionItemVaultAggregated {
