...
impl StateEntityDetailsResponsePackageDetails {
    pub fn new(r#type: crate::models::StateEntityDetailsResponseItemDetailsType, vm_type: crate::models::PackageVmType, code_hash_hex: String, code_hex: String) -> StateEntityDetailsResponsePackageDetails {
