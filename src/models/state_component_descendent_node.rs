...
impl StateComponentDescendentNode {
    pub fn new(parent_entity: models::EntityReference, parent_partition_number: i32, parent_substate_key_hex: String, parent_substate_db_sort_key_hex: String, entity: models::EntityReference, depth: i32) -> StateComponentDescendentNode {
