...
pub struct BlueprintInfo {
    ...
    pub generic_substitutions: Vec<crate::models::GenericSubstitution>,
}

impl BlueprintInfo {
    pub fn new(package_address: String, blueprint_name: String, blueprint_version: String, features: Vec<String>, generic_substitutions: Vec<crate::models::GenericSubstitution>) -> BlueprintInfo {
        BlueprintInfo {
            package_address,
            blueprint_name,
            blueprint_version,
