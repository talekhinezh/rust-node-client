...
impl LtsCommittedTransactionOutcome {
    ...
    pub fn new(state_version: i64, proposer_timestamp_ms: i64, accumulator_hash: String, status: models::LtsCommittedTransactionStatus, fungible_entity_balance_changes: Vec<models::LtsEntityFungibleBalanceChanges>, non_fungible_entity_balance_changes: Vec<models::LtsEntityNonFungibleBalanceChanges>, resultant_account_fungible_balances: Vec<models::LtsResultantAccountFungibleBalances>, total_fee: String) -> LtsCommittedTransactionOutcome {
