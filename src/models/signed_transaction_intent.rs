...
pub struct SignedTransactionIntent {
    ...
    #[serde(rename = "intent")]
    pub intent: Box<crate::models::TransactionIntent>,
    #[serde(rename = "intent_signatures")]
    pub intent_signatures: Vec<crate::models::SignatureWithPublicKey>,
}

impl SignedTransactionIntent {
    pub fn new(hash: String, hash_bech32m: String, intent: crate::models::TransactionIntent, intent_signatures: Vec<crate::models::SignatureWithPublicKey>) -> SignedTransactionIntent {
