...
pub struct LtsEntityFungibleBalanceChanges {
    ...
    pub fee_balance_change: Option<Box<crate::models::LtsFungibleResourceBalanceChange>>,
    #[serde(rename = "fee_balance_changes")]
    pub fee_balance_changes: Vec<crate::models::LtsFeeFungibleResourceBalanceChange>,
    #[serde(rename = "non_fee_balance_changes")]
    pub non_fee_balance_changes: Vec<crate::models::LtsFungibleResourceBalanceChange>,
}

impl LtsEntityFungibleBalanceChanges {
    pub fn new(entity_address: String, fee_balance_changes: Vec<crate::models::LtsFeeFungibleResourceBalanceChange>, non_fee_balance_changes: Vec<crate::models::LtsFungibleResourceBalanceChange>) -> LtsEntityFungibleBalanceChanges {
