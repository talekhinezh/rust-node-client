...
pub struct TransactionCallPreviewResponse {
    ...
    pub output: Option<Box<crate::models::SborData>>,
...
impl TransactionCallPreviewResponse {
    pub fn new(at_ledger_state: crate::models::LedgerStateSummary, status: crate::models::TransactionStatus) -> TransactionCallPreviewResponse {
